...
require('./utils');
require('./brain_main');
require('./brain_earlyexpansion');
require('./brain_emergency_spawn');
require('./brain_scouteliminator');
require('./brain_roomstrength');
require('./brain_remotetakeover');
require('./brain_conquest');
require('./brain_siege');
require('./brain_aggression');
require('./brain_domination');
require('./brain_military_coordinator');
require('./brain_squad_combat');
...
require('./role_dismantler');
require('./role_earlyharvester');
