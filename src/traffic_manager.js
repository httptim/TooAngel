/**
 * Screeps Traffic Manager - Monkey Patch Version
 *
 * Manages creep movement to reduce congestion and improve pathing efficiency.
 * This version automatically patches Creep.prototype.move, so you don't need to call registerMove manually.
 */
...
function registerMove(creep, target) {
  const targetCoord = typeof target === 'number' ? getDirectionTarget(creep.pos, target) : target;
